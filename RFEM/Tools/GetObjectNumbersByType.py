...
class GetAllObjects():
    ...
    def __new__(cls,
        ...
        func_vec = [[ObjectTypes.E_OBJECT_TYPE_COORDINATE_SYSTEM, lambda i: model.clientModel.service.get_coordinate_system(i), 'from RFEM.GuideObjects.coordinateSystem import CoordinateSystem\n', 'CoordinateSystem'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_CROSS_SECTION, lambda i: model.clientModel.service.get_cross_section(i), 'from RFEM.BasicObjects.crossSection import CrossSection\n', 'CrossSection'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_STEEL_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, lambda i: model.clientModel.service.get_steel_member_localcross_section_reduction(i), 'from RFEM.TypesForSteelDesign.SteelMemberLocalCrossSectionReduction import SteelMemberLocalCrossSectionReduction\n', 'SteelMemberLocalCrossSectionReduction'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_TIMBER_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, lambda i: model.clientModel.service.get_timber_member_local_cross_section_reduction(i), 'from RFEM.TypesForTimberDesign.timberMemberLocalCrossSectionReduction import TimberMemberLocalCrossSectionReduction\n', 'TimberMemberLocalCrossSectionReduction'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_ALUMINUM_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, lambda i: model.clientModel.service.get_aluminum_member_localcross_section_reduction(i), 'from RFEM.TypesForAluminumDesign.aluminumMemberLocalCrossSectionReduction import AluminumMemberLocalCrossSectionReduction\n', 'AluminumMemberLocalCrossSectionReduction'],
