...
class GetAllObjects():
    ...
    def __new__(cls,
        ...
        func_vec = [[ObjectTypes.E_OBJECT_TYPE_COORDINATE_SYSTEM, lambda i: model.clientModel.service.get_coordinate_system(i), 'from RFEM.GuideObjects.coordinateSystem import CoordinateSystem\n', 'CoordinateSystem'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_STEEL_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, lambda i: model.clientModel.service.get_steel_member_local_cross_section_reduction(i), 'from RFEM.TypesForSteelDesign.SteelMemberLocalSectionReduction import SteelMemberLocalSectionReduction\n', 'SteelMemberLocalSectionReduction'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_ALUMINUM_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, lambda i: model.clientModel.service.get_timber_member_local_cross_section_reduction(i), 'from RFEM.TypesForTimberDesign.timberMemberLocalSectionReduction import TimberMemberLocalSectionReduction\n', 'TimberMemberLocalSectionReduction'],
            ...
            [ObjectTypes.E_OBJECT_TYPE_ALUMINUM_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, lambda i: model.clientModel.service.get_aluminum_member_local_cross_section_reduction(i), 'from RFEM.TypesForAluminumDesign.aluminumMemberLocalSectionReduction import AluminumMemberLocalSectionReduction\n', 'AluminumMemberLocalSectionReduction'],
