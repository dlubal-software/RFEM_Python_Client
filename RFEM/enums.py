...
class ObjectTypes(Enum):
    ...
    E_OBJECT_TYPE_REINFORCEMENT_DIRECTIONS, E_OBJECT_TYPE_SURFACE_REINFORCEMENTS, E_OBJECT_TYPE_CONCRETE_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_CONCRETE_DESIGN_ULS_CONFIGURATION, \
    E_OBJECT_TYPE_STEEL_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_STEEL_DESIGN_ULS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_DESIGN_ULS_CONFIGURATION = range(128)
