...
class ObjectTypes(Enum):
    ...
    Object Types
    '''
    E_OBJECT_TYPE_ACTION_COMBINATION, E_OBJECT_TYPE_ACCELEROGRAM, E_OBJECT_TYPE_ACTION, E_OBJECT_TYPE_ALUMINUM_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_ALUMINUM_DESIGN_ULS_CONFIGURATION, \
    E_OBJECT_TYPE_ALUMINUM_EFFECTIVE_LENGTHS, E_OBJECT_TYPE_ALUMINUM_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, E_OBJECT_TYPE_ALUMINUM_MEMBER_TRANSVERSE_WELD, E_OBJECT_TYPE_BOREHOLE, \
    E_OBJECT_TYPE_BUILDING_GRID, E_OBJECT_TYPE_BUILDING_STORY, E_OBJECT_TYPE_CALCULATION_DIAGRAM, E_OBJECT_TYPE_CLIPPING_BOX, E_OBJECT_TYPE_CLIPPING_PLANE, E_OBJECT_TYPE_COMBINATION_WIZARD, \
    E_OBJECT_TYPE_CONCRETE_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_CONCRETE_DESIGN_ULS_CONFIGURATION, E_OBJECT_TYPE_CONCRETE_DURABILITY, E_OBJECT_TYPE_CONCRETE_EFFECTIVE_LENGTHS, \
    E_OBJECT_TYPE_CONSTRUCTION_STAGE, E_OBJECT_TYPE_COORDINATE_SYSTEM, E_OBJECT_TYPE_DESIGN_SITUATION, E_OBJECT_TYPE_DESIGN_SUPPORT, E_OBJECT_TYPE_DIMENSION, E_OBJECT_TYPE_DXF_FILE_MODEL_OBJECT, \
    E_OBJECT_TYPE_DXF_MODEL_OBJECT, E_OBJECT_TYPE_FLOOR_SET, E_OBJECT_TYPE_FREE_CIRCULAR_LOAD, E_OBJECT_TYPE_FREE_CONCENTRATED_LOAD, E_OBJECT_TYPE_FREE_LINE_LOAD, E_OBJECT_TYPE_FREE_POLYGON_LOAD, \
    ...
    E_OBJECT_TYPE_INTERSECTION, E_OBJECT_TYPE_LINE, E_OBJECT_TYPE_LINE_HINGE, E_OBJECT_TYPE_LINE_LOAD, E_OBJECT_TYPE_LINE_MESH_REFINEMENT, E_OBJECT_TYPE_LINE_RELEASE, E_OBJECT_TYPE_LINE_RELEASE_TYPE, \
    E_OBJECT_TYPE_LINE_SET, E_OBJECT_TYPE_LINE_SET_LOAD, E_OBJECT_TYPE_LINE_SUPPORT, E_OBJECT_TYPE_LINE_WELDED_JOINT, E_OBJECT_TYPE_LOAD_CASE, E_OBJECT_TYPE_LOAD_COMBINATION, \
    E_OBJECT_TYPE_MATERIAL, E_OBJECT_TYPE_MEMBER, E_OBJECT_TYPE_MEMBER_DEFINABLE_STIFFNESS, E_OBJECT_TYPE_MEMBER_ECCENTRICITY, E_OBJECT_TYPE_MEMBER_HINGE, E_OBJECT_TYPE_MEMBER_IMPERFECTION, \
    E_OBJECT_TYPE_MEMBER_LOAD, E_OBJECT_TYPE_MEMBER_NONLINEARITY, E_OBJECT_TYPE_MEMBER_OPENINGS, E_OBJECT_TYPE_MEMBER_REPRESENTATIVE, E_OBJECT_TYPE_MEMBER_RESULT_INTERMEDIATE_POINT, \
    E_OBJECT_TYPE_MEMBER_ROTATIONAL_RESTRAINT, E_OBJECT_TYPE_MEMBER_SET, E_OBJECT_TYPE_MEMBER_SET_IMPERFECTION, E_OBJECT_TYPE_MEMBER_SET_LOAD, E_OBJECT_TYPE_MEMBER_SET_REPRESENTATIVE, \
    E_OBJECT_TYPE_MEMBER_SHEAR_PANEL, E_OBJECT_TYPE_MEMBER_STIFFNESS_MODIFICATION, E_OBJECT_TYPE_MEMBER_SUPPORT, E_OBJECT_TYPE_MEMBER_TRANSVERSE_STIFFENER, E_OBJECT_TYPE_MODAL_ANALYSIS_SETTINGS, \
    E_OBJECT_TYPE_NODAL_LOAD, E_OBJECT_TYPE_NODAL_MESH_REFINEMENT, E_OBJECT_TYPE_NODAL_RELEASE, E_OBJECT_TYPE_NODAL_RELEASE_TYPE, E_OBJECT_TYPE_NODAL_SUPPORT, E_OBJECT_TYPE_NODE, \
    E_OBJECT_TYPE_NOTE, E_OBJECT_TYPE_OBJECT_SNAP, E_OBJECT_TYPE_OPENING, E_OBJECT_TYPE_OPENING_LOAD, E_OBJECT_TYPE_OPTIMIZATION_SETTINGS, E_OBJECT_TYPE_PUNCHING_REINFORCEMENT, \
    E_OBJECT_TYPE_PUSHOVER_ANALYSIS_SETTINGS, E_OBJECT_TYPE_REINFORCEMENT_DIRECTION, E_OBJECT_TYPE_RELATIONSHIP_BETWEEN_LOAD_CASES, E_OBJECT_TYPE_RESPONSE_SPECTRUM, E_OBJECT_TYPE_RESULT_COMBINATION, \
    E_OBJECT_TYPE_RESULT_SECTION, E_OBJECT_TYPE_RIGID_LINK, E_OBJECT_TYPE_CROSS_SECTION, E_OBJECT_TYPE_SHEAR_WALL, E_OBJECT_TYPE_SOIL_MASSIF, E_OBJECT_TYPE_SOLID, E_OBJECT_TYPE_SOLID_CONTACTS, \
    E_OBJECT_TYPE_SOLID_GAS, E_OBJECT_TYPE_SOLID_LOAD, E_OBJECT_TYPE_SOLID_MESH_REFINEMENT, E_OBJECT_TYPE_SOLID_SET, E_OBJECT_TYPE_SOLID_SET_LOAD, E_OBJECT_TYPE_SPANDREL, E_OBJECT_TYPE_SPECTRAL_ANALYSIS_SETTINGS, \
    E_OBJECT_TYPE_STABILITY_ANALYSIS_SETTINGS, E_OBJECT_TYPE_STATIC_ANALYSIS_SETTINGS, E_OBJECT_TYPE_STEEL_BOUNDARY_CONDITIONS, E_OBJECT_TYPE_STEEL_DESIGN_FR_CONFIGURATION, \
    E_OBJECT_TYPE_STEEL_DESIGN_SEISMIC_CONFIGURATION, E_OBJECT_TYPE_STEEL_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_STEEL_DESIGN_ULS_CONFIGURATION, E_OBJECT_TYPE_STEEL_EFFECTIVE_LENGTHS, \
    E_OBJECT_TYPE_STEEL_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, E_OBJECT_TYPE_STRUCTURE_MODIFICATION, E_OBJECT_TYPE_SURFACE, E_OBJECT_TYPE_SURFACES_CONTACT, E_OBJECT_TYPE_SURFACES_CONTACT_TYPE, \
    E_OBJECT_TYPE_SURFACE_ECCENTRICITY, E_OBJECT_TYPE_SURFACE_IMPERFECTION, E_OBJECT_TYPE_SURFACE_LOAD, E_OBJECT_TYPE_SURFACE_MESH_REFINEMENT, E_OBJECT_TYPE_SURFACE_REINFORCEMENT, \
    E_OBJECT_TYPE_SURFACE_RELEASE, E_OBJECT_TYPE_SURFACE_RELEASE_TYPE, E_OBJECT_TYPE_SURFACE_RESULTS_ADJUSTMENT, E_OBJECT_TYPE_SURFACE_SET, E_OBJECT_TYPE_SURFACE_SET_IMPERFECTION, \
    E_OBJECT_TYPE_SURFACE_SET_LOAD, E_OBJECT_TYPE_SURFACE_STIFFNESS_MODIFICATION, E_OBJECT_TYPE_SURFACE_SUPPORT, E_OBJECT_TYPE_TERRAIN, E_OBJECT_TYPE_THICKNESS, E_OBJECT_TYPE_TIMBER_DESIGN_FR_CONFIGURATION, \
    E_OBJECT_TYPE_TIMBER_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_DESIGN_ULS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_EFFECTIVE_LENGTHS, E_OBJECT_TYPE_TIMBER_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, \
    E_OBJECT_TYPE_TIMBER_MOISTURE_CLASS, E_OBJECT_TYPE_TIMBER_SERVICE_CLASS, E_OBJECT_TYPE_TIMBER_SERVICE_CONDITIONS, E_OBJECT_TYPE_VISUAL_OBJECT, E_OBJECT_TYPE_WIND_PROFILE, \
    E_OBJECT_TYPE_WIND_SIMULATION, E_OBJECT_TYPE_WIND_SIMULATION_ANALYSIS_SETTINGS = range(141)
...
class MemberSupportNonlinearity(Enum):
    ...
    '''
    NONLINEARITY_FAILURE_IF_NEGATIVE_CONTACT_STRESS_Z, NONLINEARITY_FAILURE_IF_POSITIVE_CONTACT_STRESS_Z, NONLINEARITY_NONE, \
    NONLINEARITY_ROTATION_RESTRAINT_ABOUT_X, NONLINEARITY_SHEAR_PANEL_IN_Y, NONLINEARITY_SHEAR_PANEL_IN_Z = range(6)
