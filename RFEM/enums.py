...
class ObjectTypes(Enum):
    ...
    E_OBJECT_TYPE_RESPONSE_SPECTRUM, E_OBJECT_TYPE_LINE_RELEASE, E_OBJECT_TYPE_LINE_RELEASE_TYPE, E_OBJECT_TYPE_CONCRETE_EFFECTIVE_LENGTHS, E_OBJECT_TYPE_CONCRETE_DURABILITY, \
    E_OBJECT_TYPE_REINFORCEMENT_DIRECTION, E_OBJECT_TYPE_SURFACE_REINFORCEMENT, E_OBJECT_TYPE_CONCRETE_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_CONCRETE_DESIGN_ULS_CONFIGURATION, \
    E_OBJECT_TYPE_STEEL_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_STEEL_DESIGN_ULS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_DESIGN_ULS_CONFIGURATION, \
    E_OBJECT_TYPE_MEMBER_ROTATIONAL_RESTRAINT, E_OBJECT_TYPE_MEMBER_SHEAR_PANEL = range(124)
