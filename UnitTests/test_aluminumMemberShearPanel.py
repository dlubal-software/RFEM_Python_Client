...
def test_steelMemberShearPanel():
    ...
    AluminumMemberShearPanel(2, [True, "shearPanel"], AluminumMemberShearPanelDefinitionType.DEFINITION_TYPE_TRAPEZOIDAL_SHEETING, "1", "",
    ...
    AluminumMemberShearPanel(3, [False], AluminumMemberShearPanelDefinitionType.DEFINITION_TYPE_BRACING, "", "",
