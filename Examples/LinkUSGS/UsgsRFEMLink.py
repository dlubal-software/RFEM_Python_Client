...
logoColumn, titleColumn = st.columns([1,10])
with logoColumn:
...
initAsceMulti = getAsceDataMulti(38, -110, 'III', 'C', 'dashCall')
...
initAsceMultiMCEr = getAsceDataMultiMCEr(38, -110, 'III', 'C', 'dashCall')
...
initAsceTwoData = getAsceDataTwo(38, -110, 'III', 'C', 'dashCall')
...
initAsceTwoDataMCEr = getAsceDataTwoMCEr(38, -110, 'III', 'C', 'dashCall')
