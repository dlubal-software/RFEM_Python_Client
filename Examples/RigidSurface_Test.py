...
if __name__ == '__main__':
    ...
    Surface.Rigid(1, 2, SurfaceGeometry.GEOMETRY_PLANE, boundary_lines_no= '5 6 7 8')
    ...
    # Fläche definieren
    Surface.Rigid(1, 3, SurfaceGeometry.GEOMETRY_NURBS, [3,3,3,3], '9 10 11 12')
    ...
    Surface.Rigid(1, 4, SurfaceGeometry.GEOMETRY_QUADRANGLE, [17, 18, 19, 20], '13 14 15 16')
